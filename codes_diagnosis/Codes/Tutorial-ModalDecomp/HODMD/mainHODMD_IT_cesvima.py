...
param['database_path'] = '/home/w460/SCRATCH/Andres/Databases/Mice_ecos/Ecos_tutorials/LAX/Results_step2/svd_reconst_data'
...
param['results_path'] = '/home/w460/SCRATCH/Andres/Databases/Mice_ecos/Ecos_tutorials/LAX/Results_step3'

    # input('Write a path in which results will be saved or press enter to save in the project directory: ')
...
param['colormap'] = None
    ...
    # input('Select colormap or press enter to continue with gray: ')
...
param['svd_library'] = 'hybrid_lower_precision'

    # input('Introduce library to use for SVD or press enter to continue with torch \nOptions: \nnumpy \ntorch \ntensorflow \nhybrid \nhybrid_lower_precision: ')
...
param['svd_driver'] = None
    ...
    # input('Introduce driver to use for the case of SVD CUDA or press enter to continue with None: ')
...
# input('Introduce number of snapshots or press enter to continue with a number of snapshots corresponding to the size of the temporal dimension of the input data: ')
...
param['varepsilon1'] = None

    # input('Introduce first tolerance (SVD) or press enter to continue with 0.0005: ')
if not param['varepsilon1']:
    param['varepsilon1'] = 0.0005  # SVD
else:
    param['varepsilon1'] = float(param['varepsilon1'])

param['varepsilon2'] = None

    # input('Introduce second tolerance (DMD-d Modes) or press enter to continue with 0.0005: ')
...
param['d'] = '/5'
    ...
    # input('Introduce parameter of DMD-d (d) or press enter to continue with 1 (options: a number; /3 or /5): ')
if not param['d']:
    param['d'] = 1
...
param['deltaT'] = None
    ...
    # input('Introduce time gradient (deltaT) or press enter to continue with 0.004: ')
