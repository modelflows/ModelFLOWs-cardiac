...
#SBATCH --output=output-mainSVD_abs-%j.log
#SBATCH --error=error-mainSVD_abs-%j.log
##------------------------ End job description ------------------------
...
torchrun --rdzv-endpoint=0.0.0.0:29720 SVD/mainSVD_abs.py
