...
Tensors, list_data_info, _ = data_load_HUMAN_imag.main(param)
...
param['filen'] = '/home/ander/Escritorio/Workshop2025-2026/Results_step4_imag' # input('Enter folder name to save the outputs or continue with default folder name: ')
