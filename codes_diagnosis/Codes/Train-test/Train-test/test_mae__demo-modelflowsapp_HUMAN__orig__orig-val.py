...
param['training_database_path'] = ['/home/w460/SCRATCH/Andres/Databases/Human_ecos/Ecos_tutorials_AI/ecos_orig/ecos_orig_Training']


# List of full path directories
# Each with the classes, in turn the sequences, and, finally, the .npy files
param['validation_database_path'] = ['/home/w460/SCRATCH/Andres/Databases/Human_ecos/Ecos_tutorials_AI/ecos_orig/ecos_orig_Validation'] # USED
...
param['output_dir'] = '/home/w460/SCRATCH/Andres/Models/MAE_HUMAN/model_mae_HUMAN__orig'
...
param['mean'] = (14.574991) # USED


# Std used for normalization
param['std'] = (36.86992) # USED
...
param['model_path_test'] = '/home/w460/SCRATCH/Andres/Models/MAE_HUMAN/model_mae_HUMAN__orig__2025-11-27_12-54/checkpoint-11.pth' # USED


# Full path to export results
param['test_results_path'] = '/home/w460/SCRATCH/Andres/Results/HUMAN_diagnosis/results_mae_HUMAN__orig__orig-val' # USED
