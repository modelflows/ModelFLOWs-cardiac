...
# Function to calculate MSE loss using weights for classes
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, num_classes =10, regression_mode = False, norm_pix_loss=False):
        super().__init__()
...
# --------------------------------------------------------------------------
    ...
    def patchify(self, imgs):
        # Note: C is the number of channels
        """
        imgs: (N, C, H, W)
    ...
    def forward_test(self, imgs):
        ...
        predicted_result = self.head(class_token)
