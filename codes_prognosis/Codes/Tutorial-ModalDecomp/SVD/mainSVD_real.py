...
Tensors, list_data_info, _ = data_load_real.main(param)
...
param['filen'] = '/home/w460/SCRATCH/Andres/Databases/Mice_ecos/Ecos_tutorials/LAX/Results_step4_real' # input('Enter folder name to save the outputs or continue with default folder name: ')
