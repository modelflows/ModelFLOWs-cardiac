...
Tensors, list_data_info, _ = data_load_orig.main(param)
...
param['filen'] = '/home/w460/SCRATCH/Andres/Databases/Mice_ecos/Ecos_tutorials/LAX/Results_step2' # input('Enter folder name to save the outputs or continue with default folder name: ')
