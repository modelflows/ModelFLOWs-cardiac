...
def main(param):
    while True:
        if param['filetype'].strip().lower() in ['mat', '.mat']:
            ...
            param['wantedfile'] = '/home/ander/Escritorio/Workshop2025-2026/Results_step1/original_data'
            #'/home/w460/SCRATCH/Andres/Databases/Human_ecos/Ecos_tutorials/Results_step1/original_data'
