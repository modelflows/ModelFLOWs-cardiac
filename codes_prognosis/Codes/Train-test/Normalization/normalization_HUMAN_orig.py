...
param['input_data_directories'] = ['/home/w460/SCRATCH/Andres/Databases/Human_ecos/Ecos_tutorials_AI/ecos_orig/ecos_orig_Training']

param['exported_filename'] = 'normalization_HUMAN_orig.txt'
